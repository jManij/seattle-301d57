...
console.log('New ObjectLit test: ',newObjectLit());
...
console.log('New sum and Product: ', newSumAndProduct(3, 9));
...
let newJoe = newStudent('Joe', '100', 'Schmoe');
...
// when an arrow function is used, this refers to originating context.
